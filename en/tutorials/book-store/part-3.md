...
* This modal uses `abp-dynamic-form` [tag helper](https://docs.abp.io/en/abp/latest/UI/AspNetCore/Tag-Helpers/Dynamic-Forms) to automatically create the form from the  `CreateBookViewModel` model class.
...
> See the [Confirmation Popup documentation](https://docs.abp.io/en/abp/latest/UI/Angular/Confirmation-Service) for more about this service.
