...
//[doc-nav]
{
  "Next": {
    ...
    "Path": "book-store/part-10"
  },
  "Previous": {
    "Name": "Part 8: Authors: Application Layer",
    "Path": "book-store/part-8"
  }
}
````
...
Create a new Razor Component Page, `/Pages/Authors.razor`, in the {{if UI == "MAUIBlazor"}}`Acme.BookStore.MauiBlazor`{{else}}`Acme.BookStore.Blazor`{{end}} project with the following content:
...
![bookstore-author-permissions](images/bookstore-blazor-author-permissions.png)
