...
The solution has a few host applications to run your module. Host applications are used to run your module in a fully configured application. It is useful **on development**. Host applications include some other modules in addition to the module being developed. Host applications support two types of scenarios.
