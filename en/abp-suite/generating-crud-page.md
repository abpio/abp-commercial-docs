...
* **Customizable code**: Specifies hook-points to allow adding custom code blocks. Then, the code blocks that written by you will not be overridden in the next entity generation and will be respected.
